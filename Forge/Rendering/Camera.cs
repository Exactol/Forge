...
namespace Forge
{
    class Camera //TODO make inheritable class and seperate classes that inherit cam for ortho and persp cams
    {
        ...
        {
            //Projection matrix with .1 near clip and 4000 far clip
            projectionMatrix = Matrix4.CreatePerspectiveFieldOfView(horizontalFov*(float)(Math.PI/180f), AspectRatio, nearClip, farClip);
        }
        ...
        public double HorizontalAngle
        {
            ...
            set {
                horizontalAngle = (float)Utils.WrapAngle(value);
            }
        }
